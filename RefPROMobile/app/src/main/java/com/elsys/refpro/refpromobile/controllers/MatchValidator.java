package com.elsys.refpro.refpromobile.controllers;
...
public class MatchValidator {
    ...
    public MatchValidator(String competition, String venue, String time, String date, String home, String away, String homeAbbreviature, String awayAbbreviature, int halfLength, int playersNumber, int substitutesNumber) {
