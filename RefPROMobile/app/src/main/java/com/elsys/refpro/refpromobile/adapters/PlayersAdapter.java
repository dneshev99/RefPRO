...
public class PlayersAdapter extends ArrayAdapter<PlayerDTO> {
    private List<PlayerDTO> dataSet;
    Context mContext;

    public PlayersAdapter(List<PlayerDTO> players,Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        convertView.setOnTouchListener(new PlayerTouchListener());
        return convertView;
    }
